...
namespace DA
{
    public class ProductoDA : IProductoDA
    {
        ...
        public ProductoDA(IRepositarioDapper repositorioDapper)
        {
        ...
        {
            await ValidarProductoExiste(Id);
        ...
        public async Task<ProductoPrecioUSD> Obtener(Guid Id)
        {
            ...
            var resultadoConsulta = await _sqlConnection.QueryAsync<ProductoPrecioUSD>(query, new
            {
                Id = Id
            });
            return resultadoConsulta.FirstOrDefault();
        }
        private async Task ValidarProductoExiste(Guid Id)
        {
